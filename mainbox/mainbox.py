...
class MainBoxLayout(BoxLayout):
  ...
  # Act Screen Name / Email
    ...
    self.label_email.font_size=self.ps1_base_height * size_dict['label_email']['font_size'][2]
    ...
    self.anchor_screen_name.padding=(0,self.ps1_base_height * size_dict['anchor_screen_name']['padding-top'][1],
      self.ps1_base_width * size_dict['anchor_screen_name']['padding-right'][2],0)
    self.anchor_screen_name.height=self.label_email.height + self.ps1_base_height * size_dict['anchor_screen_name']['padding-top'][1]
  ...
  #Add Act Name
    ...
    self.label_act_name.font_size = self.ps1_base_width * size_dict['label_act_name']['font_size'][2]
  ...
  def get_size_2(self,*args):
    ...
    self.input_act_name.font_size=self.ps1_base_width * size_dict['input_act_name']['font_size'][2]
    ...
    self.box_act_name.height = self.anchor_act_name_label.height + self.input_act_name.height + \
      self.ps1_base_height * size_dict['box_act_name']['padding-top'][2]
    self.box_act_name.padding =(self.ps1_base_width*size_dict['box_act_name']['padding-left'][2],
      self.ps1_base_height * size_dict['box_act_name']['padding-top'][2],
      self.ps1_base_width*size_dict['box_act_name']['padding-right'][2],0)

  #Add Act Note
    self.label_act_note.size_hint=(None,None)
    self.label_act_note.font_size = self.ps1_base_width * size_dict['label_act_note']['font_size'][2]
    Clock.schedule_once(self.get_size_3,.01)

  def get_size_3(self,*args):
    self.label_act_note.size=self.label_act_note.texture_size

    self.input_act_note.font_size=self.ps1_base_width * size_dict['input_act_note']['font_size'][2]
    ...
    self.box_act_note.padding=(self.ps1_base_width*size_dict['box_act_note']['padding-left'][2],
      self.ps1_base_height * size_dict['box_act_note']['padding-top'][2],
      self.ps1_base_width*size_dict['box_act_note']['padding-right'][2],0)

  #Add Date Time
    self.label_time.font_size = self.ps1_base_width * size_dict['label_time']['font_size'][2]
    self.label_date.font_size = self.ps1_base_width * size_dict['label_date']['font_size'][2]
  ...
  def get_size_4(self,*args):
    ...
    self.input_time.font_size = self.ps1_base_width * size_dict['input_time']['font_size'][2]
    self.input_date.font_size = self.ps1_base_width * size_dict['input_date']['font_size'][2]
  ...
  def get_size_5(self,*args):
    ...
    self.anchor_date_time.height = self.input_date.height + self.label_date.height + \
      self.ps1_base_height * size_dict['anchor_date_time']['padding-top'][2]
    self.anchor_date_time.padding =(self.ps1_base_width * size_dict['anchor_date_time']['padding-left'][2],
      self.ps1_base_height * size_dict['anchor_date_time']['padding-top'][2],
      self.ps1_base_width * size_dict['anchor_date_time']['padding-right'][2],0)

    self.btn_submit_act.font_size = self.ps1_base_width * size_dict['btn_submit_act']['font_size'][2]

    self.anchor_submit.anchor_x = "right"
    self.anchor_submit.padding = (0,0,self.ps1_base_width * size_dict['anchor_submit']['padding-right'][2],0)
...
class TextInputDynamicActNote(TextInput):
  ...
  def change_height_util(self,*args):
    ...
    self.main_box.box_act_note.height=self.main_box.input_act_note.height + self.main_box.anchor_act_note_label.height + \
      self.main_box.ps1_base_height * size_dict['box_act_note']['padding-top'][2]
